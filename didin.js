...
const nyoutube = ('©KineiBot')  //ubah di config biar ngk emro
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
            ...
            break
            case 'groupbot': {
                m.reply('Halo Kak\nGroup KineiBot: https://chat.whatsapp.com/CPTvDQoiMMO1TkNTqNL2Tp\nNOTE : Kalo kakak nya Punya Bot Masukin aja\n\n*_Makasih><_*')
            }
            break
            case 'tqto': {
...
didin.send5ButImg(i, txt, `KineiBot‡`, log0, btn, thum)
}
...
if (!isCreator) return replay(mess.owner)
            ...
            didin.sendMessage(yoi, { caption: `${melo}`, location: { jpegThumbnail: await reSize(buffer, 200, 200) }, buttons: button, footer: `KineiBot XD‡`, mentions: [m.sender] })
		}		
            }
            break
            case 'q': case 'quoted': {
...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'sand': case 'glue': case '1917': case 'leaves': {
             ...
             didin.sendMessage(m.chat, { image: { url: anu }, caption: `Done KineiBot ` }, { quoted: m })
             }
             break
...
didin.sendMessage(m.chat, { caption: 'Tu Video Nya | Jangan Lupa Subscribe KineiBot ', video: { url: data.watermark }, buttons: button, footer: `© KineiBot‡`, mentions: [sender] })
})
}
break
case 'tiktokaudio':{
...
var dev = '6289612766315@s.whatsapp.net'
...
"pollCreationMessage": {
"name": "*_Halo Kk, Saya Owner KineiBot*\n\n*_Apakah Kk Nya Puas Dengan Fitur Fitur Yang Ada Di KineiBot ?_*",
"options": [
	{
			...
			case 'confess':
				...
				header = 'hayyy'
				 ...
				 var button = [{ buttonId: `menfesconfirm`, buttonText: { displayText: `CONFIRM‡` }, type: 1 }, { buttonId: `sewabot`, buttonText: { displayText: `SEWABOT‡` }, type: 1 }]
					didin.sendMessage(`${nomor}@s.whatsapp.net`, { caption: teksnya, image: {url: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMkjAJhYezm4h6k1AJ6qfreGkaRdBcR7UHMw&usqp=CAU`}, buttons: button, footer: `KineiBot\nYouTube Channel\nhttps://youtube.com` })
...
didin.sendMessage(m.chat, { react: { text: "⏱️", key: m.key }})
  	anu = `*ꜱᴀʏᴀ KineiBot ᴡʜᴀᴛsᴀᴘᴘ ʏᴀɴɢ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɴᴅᴀ ᴜɴᴛᴜᴋ ᴍᴇᴍᴘᴇʀᴍᴜᴅᴀʜ sᴇsᴜᴀᴛᴜ sᴇᴘᴇʀᴛɪ ᴍᴇᴍʙᴜᴀᴛ sᴛɪᴄᴋᴇʀ ᴅᴀɴ ʟᴀɪɴɴʏᴀ.*`
...
case 'tesrow':{
  ...
  const listMessage = {
   text: `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Aku KineiBot whatsapp multi-device yang dapat membantumu_`,
   footer: "© ~*KineiBot*~",
   title: "",
...
case 'gamemenu':{
  ...
  const listMessage = {
   text: `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Berikut Game" Yang Tersedia Di KineiBot`,
   footer: "KineiBot",
   title: "",
   buttonText: "Buka!",
   sections
...
let sections = [
                ...
                didin.sendListMsg(m.chat, `*❏ KineiBot*
...
- Dana : Gratis Bg
- PULSA : Gratis Bg
- Youtube : https://youtube.com/KineiBot
